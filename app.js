...
if (location.pathname.includes('version-test') && location.searchParams.get('openbuild')) {
var url = "https://openbuild-app.bubbleapps.io/version-test/bstyles"
    ...
    icon.style.borderLeft = '1px solid #ebf0f2';
    icon.style.borderRight = '1px solid #ebf0f2';
    var box = document.querySelector('body > div.body > div.menu-bar > div.icon_bar');
...
function hslToHex(h, s, l) {
  ...
  jsontocss(generateStyles())

  
// function to trasform st into inl
